...
import day13.first.Direction.DOWN
import day13.first.Direction.LEFT
import day13.first.Direction.RIGHT
import day13.first.Direction.UP
...
fun main() = timeSolution {
  ...
  val cartLocations = Array(circuit.first().size + 1) { BooleanArray(circuit.size+1) { false } }
  ...
  while (!collision) {
    ...
    val location = circuit[y][x]
    val newCart = when (location) {
